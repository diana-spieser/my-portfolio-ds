...
project2 = Project.new(title: "Suivez facilement votre patrimoine avec My Invest!", description: "My invest est un outil de gestion qui permet de piloter regrouper vos investissements: crypto, immobilier, comptes en banque, custom invest mais aussi vos crédits. Avec mes deux collègues Kevin et Teddy nous avons imaginé un dashboard interactif qui regroupe l'ensemble des passifs et actifs de l'utilisateur pour avoir une vision claire. Nous avons réussi à intégrer 2 API's ( sur le prix au m2 de immobilier) et sur la crypto qui étaient disponible gratuitement mais nous comptons pas à nous arrêter là ! L'application a beaucoup de potentiel et nous allons continuer à la developper en attirant des investisseurs potentiels.", link: "http://www.myinvest.shop/")
